...
@section('content')
                                      ...
                                      @forelse ($brands as $brand)
										...
										<tr>
											...
											<td>
												...
												<a href="javascript:void(0)" class="text-danger w-4 h-4 mr-1" onclick="deleteRecode({{$brand->id}});" >
                                         ...
                                         @empty
                                        <tr>
                                            <td colspan="5">Recode not found!</td>
                                        </tr>
                ...
                <script>
                   function deleteRecode(id){
                    $.get("{{ route('brand.destroy') }}", { id: id }, function(data) {
                             cosole.log(data);
                           }, 'json');
