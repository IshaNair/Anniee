								...
								<div class="row">
									<div class="col-md-4">
										<div class="mb-3">
											...
											<input type="text" name="brand_name" value="{{ old('brand_name', $brand->brand_name )}}" id="brand_name" onchange="getslug();" class="form-control @error ('brand_name') is-invalid @enderror" placeholder="Name">
										   @error('brand_name')
